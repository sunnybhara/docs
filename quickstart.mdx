...
<Steps>
  <Step title="Get your API key">
    Sign up at [trynawa.com](https://trynawa.com), then visit [trynawa.com/developers/keys](https://trynawa.com/developers/keys) to create your API key. Sandbox keys start with `nawa_test_sk_` and include 100 free requests with no credit card required.
