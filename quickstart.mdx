  ...
  <Step title="Read the response">
    ...
    ```json
    {
      ...
      "result": {
        ...
        "priority": "medium",
        "suggested_reply": {
          "text": "سؤال يستفسر عن موعد الجزء التالي",
          "direction": "rtl"
        },
        "provider": "allam",
    ...
    **Key response fields:**
    ...
    |-------|------|-------------|
    | `id` | string | Classification ID (`cls_nw_xxx` format) for use with the feedback endpoint |
    ...
    | `dialect_confidence` | number \| null | Confidence score between 0 and 1 |
    ...
    | `cost_usd` | number | Cost in USD (free key requests are not charged) |
  </Step>
</Steps>
