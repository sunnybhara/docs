...
<Steps>
  <Step title="Get your API key">
    Email [api@trynawa.com](mailto:api@trynawa.com?subject=NAWA%20API%20Key%20Request&body=Hi%2C%20I'd%20like%20to%20request%20a%20sandbox%20API%20key%20for%20the%20NAWA%20API.%0A%0AName%3A%0AUse%20case%3A%0A) with your name and use case to receive a free sandbox API key. Sandbox keys start with `nawa_test_sk_` and include 100 free requests with no credit card required.

    <Note>
      Sandbox keys (`nawa_test_sk_xxx`) are free with no credit card required. Limited to 100 lifetime requests and 14-day expiry. They use real AI models — same accuracy as production.
    </Note>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/authentication">
    Learn about API keys, sandbox vs production, and key rotation.
  </Card>
