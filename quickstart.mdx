...
<Steps>
  ...
  <Step title="Read the response">
    ...
    **Response fields:**
    ...
    | `dialect` | string or null | One of: `gulf`, `egyptian`, `levantine`, `maghrebi`, `msa`. Null for non-Arabic. |
    | `dialect_confidence` | number or null | Confidence score between 0 and 1 |
