...
<Steps>
  <Step title="Get your API key">
    Go to [trynawa.com/developers/keys](https://trynawa.com/developers/keys) to create your free sandbox API key. Sign in with Google or email — no credit card required.
