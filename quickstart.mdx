...
<Steps>
  <Step title="Get your API key">
    Sign up at [developers.trynawa.com/quickstart](https://developers.trynawa.com/quickstart) and create a sandbox key. Sandbox keys start with `nawa_test_sk_` and are free — no credit card required.
