...
<Steps>
  <Step title="Get your API key">
    ...
    <Note>
      Free keys (`nawa_test_sk_xxx`) include 100 lifetime requests with a 14-day expiry. They use real AI models with the same accuracy as live keys.
    </Note>
  </Step>
  ...
  <Step title="Read the response">
    ...
    **Key response fields:**
    ...
    | `dialect` | string | `gulf`, `egyptian`, `levantine`, `maghrebi`, or `msa` |
    | `dialect_confidence` | number | Confidence score between 0 and 1 |
    | `requires_response` | boolean | Whether this text warrants a reply |
...
<CardGroup cols={2}>
  ...
  <Card title="Dialect detection" icon="language" href="/guides/arabic-dialect-detection">
    Deep dive into Gulf, Egyptian, Levantine, Maghrebi, and MSA classification.
  </Card>
