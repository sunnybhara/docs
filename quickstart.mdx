...
<Steps>
  <Step title="Get your API key">
    Sign up at [developers.trynawa.com/dashboard](https://developers.trynawa.com/dashboard) and create a sandbox key. Sandbox keys start with `nawa_test_sk_` and are free — no credit card required.
