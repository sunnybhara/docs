...
<Steps>
  <Step title="Get your API key">
    ...
    <Note>
      Free keys (`nawa_test_sk_xxx`) require no credit card. Limited to 100 lifetime requests. They use real AI models -- same accuracy as paid keys.
    </Note>
  </Step>
  ...
  <Step title="Read the response">
    ...
    **Key response fields:**
    ...
    | `suggested_reply` | object | AI-generated reply with text and direction |
