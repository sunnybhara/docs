...
| **Trial** | 60 | Live keys without credits purchased |
...
<Note>
  Free keys are rate-limited to 10 requests/minute and have a hard cap of 100 lifetime requests. Live keys without a credit purchase start at the Trial tier (60/min). Purchasing credits upgrades you to Growth (120/min). Enterprise tiers are available on request.
</Note>
