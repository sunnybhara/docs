...
<Note>
  Free keys are rate-limited to 10 requests/minute and have a hard cap of 100 lifetime requests. Trial keys allow 60 requests/minute. Live keys with purchased credits start at the Growth tier (120/min). Enterprise tiers are available on request -- contact [sales@trynawa.com](mailto:sales@trynawa.com).
</Note>
