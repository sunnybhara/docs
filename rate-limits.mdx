...
| **Trial** | 60 | Live keys with no credit purchase yet |
...
<Note>
  Free keys are rate-limited to 10 requests/minute and have a hard cap of 100 lifetime requests. New live keys start at the Trial tier (60/min) and upgrade to Growth (120/min) after purchasing credits. Enterprise tiers are available on request -- contact [sales@trynawa.com](mailto:sales@trynawa.com).
</Note>
