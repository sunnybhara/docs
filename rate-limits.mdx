...
<Note>
  Free keys are rate-limited to 10 requests/minute and have a hard cap of 100 lifetime requests. Live keys start at the Trial tier (60/min) and move to Growth (120/min) when you purchase credits. Enterprise tiers are available on request -- contact [sales@trynawa.com](mailto:sales@trynawa.com).
</Note>
