...
| **Trial** | 60 | New live keys (`nawa_live_sk_`) |
| **Growth** | 120 | Live keys with active credit balance |
...
<Note>
  Sandbox keys are rate-limited to 10 requests/minute and have a hard cap of 100 lifetime requests. Trial keys start at 60/min, and Growth keys at 120/min. Enterprise tiers are available on request -- contact [sales@trynawa.com](mailto:sales@trynawa.com).
</Note>
