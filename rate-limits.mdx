...
|------|-------------|----------------|
| **Free** (sandbox) | 10 | Free keys (`nawa_test_sk_`) |
...
<Note>
  Free keys are rate-limited to 10 requests/minute and have a hard cap of **100 lifetime requests** (not per month). Credits are not deducted for free keys. Live keys start at the Growth tier (120/min). Enterprise tiers are available on request -- contact [sales@trynawa.com](mailto:sales@trynawa.com).
</Note>
