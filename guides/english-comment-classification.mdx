...
The `POST /v1/comments/reply` endpoint also handles English. Arabic replies match the detected dialect. English replies are natural and platform-appropriate.

Pass your comment text in the `text` field and set `tone` to control the reply style.
