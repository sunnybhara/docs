...
description: "How NAWA detects Gulf, Egyptian, Levantine, and MSA Arabic dialects with 94%+ accuracy."
---

# Arabic dialect detection

NAWA classifies Arabic text into four major dialect groups with 94%+ accuracy, powered by HUMAIN's ALLaM large language model — the most advanced Arabic AI model available.
