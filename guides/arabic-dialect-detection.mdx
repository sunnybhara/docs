...
description: "How NAWA detects Gulf, Egyptian, Levantine, Maghrebi, and MSA Arabic dialects."
---

NAWA classifies Arabic text into five major dialect groups, powered by HUMAIN's ALLaM large language model -- the most advanced Arabic AI model available.
...
| **Maghrebi** | `maghrebi` | Morocco, Algeria, Tunisia, Libya | <span dir="rtl">بزاف، واش، كيفاش، ديال</span> |
...
<AccordionGroup>
  ...
  <Accordion title="Maghrebi Arabic">
    **Comment:** "واش هاد الفيديو ديال المغرب؟ بزاف زوين"

    **Translation:** "Is this video from Morocco? Very nice"

    **Markers:** `واش` (is -- Maghrebi), `ديال` (of -- Maghrebi), `بزاف` (very -- Maghrebi)
