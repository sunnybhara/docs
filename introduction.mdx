...
NAWA is purpose-built for Arabic social media. Classify text by intent, sentiment, dialect, and priority -- powered by NAGL (NAWA Augmented Generation Layer) with multi-provider routing to [HUMAIN's ALLaM](https://humain.com), Claude, and Gemini.
