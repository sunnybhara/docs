...
description: "API key management, sandbox vs production modes, and security best practices."
---
...
|-------------|--------|---------|
| Sandbox | `nawa_test_sk_` | `nawa_test_sk_a1b2c3d4e5f6` |
| Production | `nawa_live_sk_` | `nawa_live_sk_x9y8z7w6v5u4` |
...
<Steps>
  <Step title="Sign in to the dashboard">
    Go to [developers.trynawa.com/quickstart](https://developers.trynawa.com/quickstart) and sign in with your account.
  </Step>
  <Step title="Create a new key">
    Navigate to **Settings → API Keys → Create Key**. Choose sandbox or production.
  </Step>
...
We recommend rotating production keys every **90 days**. To rotate without downtime:
...
- **Use sandbox keys for development.** Reserve production keys for deployed applications.
- **Restrict keys by IP** (coming soon) for production workloads.
