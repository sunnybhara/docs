...
|-------------|--------|---------|
| Free | `nawa_test_sk_` | `nawa_test_sk_a1b2c3d4e5f67890abcdef01234567` |
| Live | `nawa_live_sk_` | `nawa_live_sk_a1b2c3d4e5f67890abcdef01234567` |

Keys consist of the prefix followed by 32 hexadecimal characters. The raw key is shown **once** at creation and stored as a SHA-256 hash. NAWA cannot retrieve your key later.
...
<CardGroup cols={2}>
  <Card title="Free" icon="flask">
    **Free, no credit card required.**
    - 100 lifetime requests (hard cap)
    - 14-day key expiry
    - Uses real AI models (same accuracy as live)
    - Rate limit: 10 requests/minute
    - Perfect for prototyping and testing
    - Free endpoints (health, analytics, comments, feedback) do not count toward the 100 limit
  </Card>
  <Card title="Live" icon="rocket">
    **Pay-as-you-go with credit packs.**
    ...
    - Rate limits by tier: Trial (60/min), Growth (120/min), Enterprise (300/min), Enterprise+ (1000/min)
    - Webhook support
    - Analytics and usage dashboards
    - Calibration controls (Enterprise tiers)
  </Card>
</CardGroup>
