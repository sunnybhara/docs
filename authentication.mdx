...
<Steps>
  ...
  <Step title="Copy your key">
    ...
    <Warning>
      API keys are shown only once at creation. They are stored as SHA-256 hashes and cannot be retrieved later. If you lose it, revoke the old key and create a new one.
    </Warning>
  </Step>
</Steps>
