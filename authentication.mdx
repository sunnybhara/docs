...
NAWA routes requests to the best available AI provider. You can override the provider using the `provider` query parameter on supported endpoints.

| Provider | Description |
|----------|-------------|
| `allam` | HUMAIN's ALLaM 13B. Default for Arabic text. |
| `claude` | Anthropic Claude Haiku 4.5. Fallback and English default. |
| `gemini` | Google Gemini. Available for A/B testing. |
