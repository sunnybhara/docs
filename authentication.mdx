...
|-------------|--------|---------|
| Free (sandbox) | `nawa_test_sk_` | `nawa_test_sk_a1b2c3d4e5f6` |
| Live | `nawa_live_sk_` | `nawa_live_sk_x9y8z7w6v5u4` |

## Free vs live keys

<CardGroup cols={2}>
  <Card title="Free (sandbox)" icon="flask">
...
<Steps>
  ...
  <Step title="Create a new key">
    Click **Create Key**. Your first key is a free sandbox key. After purchasing credits, new keys are created as live keys.
  </Step>
