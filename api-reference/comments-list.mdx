...
<Note>
  Comment history storage is progressively rolling out. If no classifications have been stored yet, the endpoint returns an empty array with a descriptive message.
</Note>
