...
| `categories` | object | Boolean flags for each of the 7 moderation categories |
...
NAWA checks for 7 content categories:
...
| Status | Type | When |
|--------|------|------|
| 400 | `invalid_request_error` | Missing `text`. Invalid strictness or platform. Text too long (over 5,000 characters). |
