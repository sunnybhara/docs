...
Classify an Arabic comment with a single request. Returns intent, sentiment, dialect, priority, and a suggested reply direction powered by HUMAIN's ALLaM model.
...
```json
{
  ...
  "result": {
    ...
    "priority": "medium",
    "suggested_reply": {
      "text": "تعليق يطرح سؤال عن موعد الجزء الثاني",
      "direction": "rtl"
    },
    "provider": "allam",
...
| `intent` | string[] | Detected intents (e.g. `["question"]`, `["praise"]`, `["question", "complaint"]`) |
...
| `suggested_reply` | object | Contains `text` (reasoning) and `direction` (`rtl` or `ltr`) |
  ...
  <Accordion title="Egyptian Arabic complaint">
    ...
    ```json
    {
      ...
      "result": {
        ...
        "priority": "high",
        "suggested_reply": {
          "text": "شكوى بشأن جودة الصوت في الفيديو",
          "direction": "rtl"
        },
        "provider": "allam",
        "model": "sdaia/allam-1-13b-instruct",
      ...
      "errors": [],
      "request_id": "req_nw_mno345pqr678efgh"
    }
    ```
  </Accordion>
  ...
  <Accordion title="Levantine Arabic suggestion">
    ...
    ```json
    {
      ...
      "result": {
        ...
        "priority": "low",
        "suggested_reply": {
          "text": "اقتراح بتغطية المطاعم في لبنان",
          "direction": "rtl"
        },
        "provider": "allam",
        "model": "sdaia/allam-1-13b-instruct",
      ...
      "errors": [],
      "request_id": "req_nw_stu901vwx234ijkl"
    }
    ```
  </Accordion>
</AccordionGroup>
