...
Classify Arabic or English text with a single request. Returns intent, sentiment, dialect, priority, and a suggested reply direction. Supports semantic caching and A/B provider testing.
...
| `X-NAWA-Calibration-Version` | Version of your calibration thresholds applied |
...
<AccordionGroup>
  ...
  <Accordion title="Question requiring response">
    ```bash
    curl -X POST https://api.trynawa.com/v1/classify \
      -H "Authorization: Bearer nawa_live_sk_xxx" \
      -H "Content-Type: application/json" \
    ...
    ```json
    {
      ...
      "result": {
        ...
        "language": "ar",
        "dialect": "gulf",
        "dialect_confidence": 0.89,
        "requires_response": true,
        "priority": "high",
        "suggested_reply": {
          "text": "سؤال عن موعد إصدار المحتوى القادم",
          "direction": "rtl"
        },
        "provider": "allam",
        "model": "sdaia/allam-1-13b-instruct",
