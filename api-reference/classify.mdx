...
Classify Arabic or English text with a single request. Returns intent, sentiment, dialect, priority, and a suggested reply direction. Powered by NAWA's NAGL pipeline with ALLaM, Gemini, and Claude providers.
...
| `requires_response` | boolean | Whether the comment needs a response |
...
<AccordionGroup>
  ...
  <Accordion title="Levantine Arabic -- Suggestion">
    ...
    ```json
    {
      ...
      "errors": [],
      "request_id": "req_nw_stu901vwx234yz5678ab"
    }
    ```
  </Accordion>
