...
```json
{
  ...
  "result": {
    ...
    "priority": "medium",
    "suggested_reply": {
      "text": "سؤال من المستخدم يستفسر عن الجزء الثاني",
      "direction": "rtl"
    },
    "provider": "allam",
...
| `dialect` | string \| null | Arabic dialect: `gulf`, `egyptian`, `levantine`, `maghrebi`, `msa` |
| `dialect_confidence` | number \| null | Confidence score (0-1) |
| `requires_response` | boolean | Whether the text warrants a reply |
  ...
  <Accordion title="Egyptian Arabic - Complaint">
    ...
    ```json
    {
      ...
      "result": {
        ...
        "priority": "high",
        "suggested_reply": {
          "text": "شكوى من المستخدم بخصوص جودة الصوت",
          "direction": "rtl"
        },
        "provider": "allam",
        "model": "sdaia/allam-1-13b-instruct",
      ...
      "errors": [],
      "request_id": "req_nw_e5f6a7b890abcdef12345678"
    }
    ```
  </Accordion>
  ...
  <Accordion title="Levantine Arabic - Suggestion">
    ...
    ```json
    {
      ...
      "result": {
        ...
        "priority": "low",
        "suggested_reply": {
          "text": "اقتراح من المستخدم لتغطية المطاعم في لبنان",
          "direction": "rtl"
        },
        "provider": "allam",
        "model": "sdaia/allam-1-13b-instruct",
      ...
      "errors": [],
      "request_id": "req_nw_a7b8c9d0e1f2abcdef345678"
    }
    ```
  </Accordion>
</AccordionGroup>
