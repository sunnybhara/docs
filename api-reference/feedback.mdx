...
Submit reinforcement learning from human feedback (RLHF) to continuously improve NAWA's classification accuracy. Feedback is stored and periodically processed through pattern matching and drift prevention.
...
| `corrected_intent` | string[] | No | The correct intent values (e.g., `["question", "suggestion"]`). |
