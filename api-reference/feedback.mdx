...
description: "Submit feedback on a classification result to improve accuracy over time."
api: "POST https://api.trynawa.com/v1/feedback"
---

Submit feedback on a classification result to improve NAWA's accuracy through reinforcement learning.
