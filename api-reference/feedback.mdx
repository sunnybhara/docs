...
Submit feedback on a classification result to improve NAWA's accuracy. Used for reinforcement learning from human feedback (RLHF). Supports rating a classification as correct, incorrect, or partial, with optional corrections.
...
curl -X POST "https://api.trynawa.com/v1/feedback" \
  ...
  -d '{
    ...
    "comment": "This comment was sarcastic, not positive"
  }'
```
