...
<Tip>
  Every feedback submission helps improve accuracy for all NAWA users. Quorum-based pattern confirmation ensures corrections are validated before being applied.
</Tip>
...
```json
{
  ...
  "errors": [],
  "request_id": "req_nw_fb_abc12345678901234567"
}
```
