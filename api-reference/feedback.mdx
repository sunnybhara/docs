...
Submit feedback on a classification result to improve NAWA's accuracy through reinforcement learning from human feedback (RLHF).
...
|-----------|------|----------|-------------|
| `classification_id` | string | Yes | The classification ID (`cls_nw_xxx`) from a classify response. |
