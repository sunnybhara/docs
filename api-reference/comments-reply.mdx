...
Classify a comment and generate a culturally-aware, dialect-matched reply in a single API call. The reply tone and length are configurable, and you can provide additional context to improve relevance.
...
| `context.brand_voice` | string | No | Description of your brand voice or style. |
