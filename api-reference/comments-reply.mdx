...
Classify a comment and generate a culturally-aware reply in a single call. The reply matches the detected language and dialect of the input. Supports tone control and max length configuration.
