...
Classify a comment and generate a culturally-aware, dialect-matched reply in a single call. The reply matches the commenter's dialect and is contextually appropriate for the detected platform.
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `text` | string | Yes | The comment text to classify and generate a reply for. |
