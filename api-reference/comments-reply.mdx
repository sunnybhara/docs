...
Classify a comment and generate a culturally-aware, dialect-matched reply in a single API call. Supports tone control and maximum reply length.
...
```json
{
  ...
  "result": {
    ...
    "reply": {
      "text": "نعتذر عن تجربتك السلبية. نحرص على تقديم أفضل المنتجات ونود مساعدتك في حل المشكلة. يرجى التواصل معنا مباشرة.",
      "direction": "rtl",
      "tone": "professional"
    },
    "provider": "allam",
  ...
  "errors": [],
  "request_id": "req_nw_rpl789abc012def345ghi678"
}
```
