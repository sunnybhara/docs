...
| `dialect_confidence` | number or null | Confidence score from 0 to 1 for dialect detection. Null if not Arabic. |
...
| Status | Type | When |
|--------|------|------|
| 400 | `invalid_request_error` | Missing `text`. Text too long (over 5,000 characters). |
