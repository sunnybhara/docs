...
| `dialect_confidence` | number or null | Confidence score (0 to 1) for dialect detection. Null if not Arabic. |
...
| Status | Type | When |
|--------|------|------|
| 400 | `invalid_request_error` | Missing `text`. Text exceeds 5,000 characters. |
