...
| `by_endpoint` | array | Breakdown by endpoint with `requests`, `cost`, `cache_hits`, `avg_latency_ms` |
| `balance` | object | Current balance with `current`, `credits_purchased`, `credits_used` |
