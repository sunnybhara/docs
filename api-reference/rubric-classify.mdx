...
| `rubric.categories` | string[] | Yes | List of category names to classify against. Max 20 categories. |
...
| Status | Type | When |
|--------|------|------|
| 400 | `invalid_request_error` | Missing `text` or `rubric`. Invalid rubric structure. Text too long. |
