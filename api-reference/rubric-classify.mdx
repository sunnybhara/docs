...
Classify text against a user-defined rubric. Define your own categories with descriptions, enable multi-label classification, and set confidence thresholds.
