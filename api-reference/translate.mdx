...
description: "Dialect-aware Arabic translation powered by HUMAIN ALLaM with Claude fallback."
...
| Status | Type | When |
|--------|------|------|
| 400 | `invalid_request_error` | Missing `text` or `target`. Invalid values. Text too long (max 5,000 chars). Source and target are the same language. |
