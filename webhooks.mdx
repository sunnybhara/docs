...
Receive real-time notifications when events occur in your NAWA account. Webhooks use HMAC-SHA256 signatures for security. You can register up to 10 webhook endpoints per account.
