...
Your webhook signing secret starts with `nawa_wh_` and is generated when you register a webhook endpoint. Store it securely because it is shown only once.
