...
Your webhook signing secret starts with `nawa_wh_` and is generated when you register a webhook endpoint. Store it securely -- it is shown only once. Each webhook endpoint has a maximum of 10 active endpoints per API key.
